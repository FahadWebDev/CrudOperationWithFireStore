package com.example.crudoperationwithfirestore;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView collectionValuesTV, getDocumentsTV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            getDocumentsTV= findViewById(R.id.getDocumentsTV);
        } catch (Exception e) {
    ...
    public void addValuesToFireStore(View v) {
        try {
            objectFirebaseFirestore = FirebaseFirestore.getInstance();
            objectFirebaseFirestore.collection(HOTEL_DETAILS).document(documentIDET.getText().toString()).get()
                    .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            ...
                            {
                                if(!documentIDET.getText().toString().isEmpty()&&!noOfRoomsET.getText().toString().isEmpty()&&!nameOfRestaurantET.getText().toString().isEmpty()
                                        && !locationOfHotelET.getText().toString().isEmpty())
                                {
                                    ...
                                    objectFirebaseFirestore.collection(HOTEL_DETAILS).document(documentIDET.getText().toString()).set(objectMap)
